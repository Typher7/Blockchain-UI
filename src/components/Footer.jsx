import Logo from "../assets/virt_curr.png";

export const Footer = () => {
  return (
    <div className="relative mt-16 bg-deep-purple-accent-400">
      <svg
        className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-sky-900"
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="transition-colors duration-300 text-deep-purple-50 hover:text-sky-800"
                  >
                    News
                  </a>
                </li>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-purple-200 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="/"
              className="transition-colors duration-300 text-deep-purple-100 hover:text-sky-800"
            >
